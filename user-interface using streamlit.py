# -*- coding: utf-8 -*-
"""
Created on Sat Nov 30 18:37:00 2024
...
# Set webpage title and favicon
st.set_page_config(
    page_title="Uber Fare Prediction",  # Name of the webpage
    page_icon="🚖"  # Icon for the tab (can be an emoji or a file path to an image)
)
